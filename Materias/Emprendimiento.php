...
<body>
    ...
    <main class= contenido >
        <center><h1 class="Titulo"><?php echo $InfoEmprendimiento[0]['Titulo']; ?></h1></center>
        <br>
        <p class="Texto"><?php echo $InfoEmprendimiento[0]['TextoTitulo']; ?></p>
        <br>
        <p class="Texto"><?php echo $InfoEmprendimiento[0]['TextoElectricidad1']; ?></p><br>
        <ul>
        <li><p class="Texto"><?php echo $InfoEmprendimiento[0]['TextoElectricidad2']; ?></p></li><br>
        <li><p class="Texto"><?php echo $InfoEmprendimiento[0]['TextoElectricidad3']; ?></p></li>
        </ul>
        <br>
        <br>
        <br>
        <center><?php echo $InfoEmprendimiento[0]['ImagenElectricidad']; ?></center><br><br>
    </main>
    
    <aside class= sidebar >
        <ul class="ListaMaterias">
            <li><h1 class="TituloMaterias"><?php echo $InfoEmprendimiento[0]['SubTitulo']; ?></h1></li><br><br>
        ...
        <div class= widget-1 >
            <p><?php echo $InfoEmprendimiento[0]['Widget-1']; ?></p>
        </div>
        <div class= widget-2 >
            <p><?php echo $InfoEmprendimiento[0]['Widget-2']; ?></p>
        </div>
    ...
    <footer class="footer">
		<div class="contenedor contenedor-footer">
			<div class="footer-text">
				<p>&copy; <?php echo $InfoEmprendimiento[0]['Footer']; ?></p>
			</div>
		</div>
	</footer>
</body>
